...
function sym(varName:string): Sym {return new Sym(varName);}

//wrapper for Scalar class
function scalar(val:number):Scalar {return new Scalar(val);}
...
function integrate(input:Sym, varName?:Sym):Sym { if (varName) {return new Sym(nerdamer.integrate(input.toString(), varName.toString()).text());} return new Sym(nerdamer.integrate(input.toString()).text());}
...
//Math Lib functions
function sin(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("sin(" + A.expression + ")");} return _MathLib.sin(A);}
function cos(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("cos(" + A.expression + ")");} return _MathLib.cos(A);}
function abs(A:Mat|number[][]|number[]|number):Mat{ return _MathLib.abs(A);}
function acos(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("acos(" + A.expression + ")");} return _MathLib.acos(A);}
function acosh(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("acosh(" + A.expression + ")");} return _MathLib.acosh(A);}
...
function exp(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("exp(" + A.expression + ")");}  return _MathLib.exp(A);}
function log(A:Mat|number[][]|number[]|number| Sym, base?:number):Mat{ if (A instanceof Sym) {return sym("log(" + A.expression + ")");}  return _MathLib.log(A, base);}
function asin(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("asin(" + A.expression + ")");}  return _MathLib.asin(A);}
function asinh(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("asinh(" + A.expression + ")");}  return _MathLib.asinh(A);}
function atan(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("atan(" + A.expression + ")");}  return _MathLib.atan(A);}
function atanh(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("atanh(" + A.expression + ")");}  return _MathLib.atanh(A);}
function tan(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("tan(" + A.expression + ")");}  return _MathLib.tan(A);}
function tanh(A:Mat|number[][]|number[]|number| Sym):Mat{ if (A instanceof Sym) {return sym("tanh(" + A.expression + ")");}  return _MathLib.tanh(A);}
