...
Let's view an example of creating `object`s:
...
:::tip
If one is curious to learn more, check out [Objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) for more info.
:::
